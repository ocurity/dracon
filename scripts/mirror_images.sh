...
images_to_mirror=(
    ...
    "gcr.io/tekton-releases/github.com/tektoncd/pipeline/cmd/imagedigestexporter@sha256:b65389daa312b9c1bfe9cc1d2c9066a877676034b4264b3576e3ccf8843b61d"
    ...
    "gcr.io/tekton-releases/github.com/tektoncd/pipeline/cmd/pullrequest-init@sha256:c80af31a67027b9e9dc9b710856ecda8137348bb82aefb1dd59949039ea17fc"
    ...
    "gcr.io/tekton-releases/github.com/tektoncd/pipeline/cmd/sidecarlogresults@sha256:4f3ac70c281f60de5634e3c8d4e17210a8d64aa6ae2d933739dbfc3cb674b80"
...
do
    grep -oE '[^ "]*@sha256:[^ "]*' third_party/k8s/tektoncd/pipeline/pipeline.yaml \
