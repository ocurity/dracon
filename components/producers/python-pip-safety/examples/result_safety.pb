...
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/61893/97cBunknownJCVE-2023-45803�
pkg:pypi/urllib3@1.24.1Vulnerable Dependencyurllib3[<1.24.2]0:�Advisory: Affected versions of urllib3 are vulnerable Improper Certificate Validation. Urllib3 mishandles certain cases where the desired set of CA certificates is different from the OS store of CA certificates, which results in SSL connections succeeding in situations where a verification failure is the correct outcome. This is related to the use of the ssl_context, ca_certs, or ca_certs_dir argument.
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/37071/97cBunknownJCVE-2019-11324�
pkg:pypi/urllib3@1.24.1Vulnerable Dependencyurllib3[<1.26.5]0:�Advisory: Urllib3 1.26.5 includes a fix for CVE-2021-33503: When provided with a URL containing many @ characters in the authority component, the authority regular expression exhibits catastrophic backtracking, causing a denial of service if a URL were passed as a parameter or redirected to via an HTTP redirect.
...
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/61601/97cBunknownJCVE-2023-43804�
pkg:pypi/urllib3@1.24.1Vulnerable Dependencyurllib3[<1.25.9]0:�Advisory: Urllib3 1.25.9 includes a fix for CVE-2020-26137: Urllib3 before 1.25.9 allows CRLF injection if the attacker controls the HTTP request method, as demonstrated by inserting CR and LF control characters in the first argument of putrequest(). NOTE: this is similar to CVE-2020-26116.
...
pkg:pypi/urllib3@1.24.1Vulnerable Dependencyurllib3[<1.24.3]0:�Advisory: Urllib3 1.24.3 includes a fix for CVE-2019-11236: CRLF injection is possible if the attacker controls the request parameter.
...
CVE-2023-4807�
pkg:pypi/cryptography@2.6.1Vulnerable Dependencycryptography[<41.0.5]0:�Advisory: Cryptography 41.0.5 updates Windows, macOS, and Linux wheels to be compiled with OpenSSL 3.1.4, that includes a security fix.
...
CVE-2023-2975�
pkg:pypi/cryptography@2.6.1Vulnerable Dependencycryptography[>=0.8,<41.0.3]0:�Advisory: Cryptography 41.0.3 updates its bundled OpenSSL version to include a fix for a Denial of Service vulnerability.
...
pkg:pypi/cryptography@2.6.1Vulnerable Dependencycryptography[<3.3]0:�Advisory: Cryptography 3.3 no longer allows loading of finite field Diffie-Hellman parameters of less than 512 bits in length. This change is to conform with an upcoming OpenSSL release that no longer supports smaller sizes. These keys were already wildly insecure and should not have been used in any application outside of testing.
...
pkg:pypi/cryptography@2.6.1Vulnerable Dependencycryptography[<39.0.1]0:�Advisory: Cryptography 39.0.1 updates its dependency 'OpenSSL' to v3.0.8 to include security fixes.
...
CVE-2023-0216�
pkg:pypi/cryptography@2.6.1Vulnerable Dependencycryptography[<39.0.1]0:�Advisory: Cryptography 39.0.1 includes a fix for CVE-2022-3996, a DoS vulnerability affecting openssl.
...
CVE-2023-0401�
pkg:pypi/cryptography@2.6.1Vulnerable Dependencycryptography[<42.0.5]0:�Advisory: Cryptography version 42.0.5 introduces a limit on the number of name constraint checks during X.509 path validation to prevent denial of service attacks.
...
CVE-2023-5678�
pkg:pypi/cryptography@2.6.1Vulnerable Dependencycryptography[<41.0.2]0:�Advisory: The cryptography package before 41.0.2 for Python mishandles SSH certificates that have critical options.
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/59473/97cBunknownJCVE-2023-38325�
pkg:pypi/cryptography@2.6.1Vulnerable Dependencycryptography[<=3.2]0:�Advisory: Cryptography 3.2 and prior are vulnerable to Bleichenbacher timing attacks in the RSA decryption API, via timed processing of valid PKCS#1 v1.5 ciphertext.
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/38932/97cBunknownJCVE-2020-25659�
pkg:pypi/cryptography@2.6.1Vulnerable Dependencycryptography[>=1.8,<39.0.1]0:�Advisory: Cryptography 39.0.1 includes a fix for CVE-2023-23931: In affected versions 'Cipher.update_into' would accept Python objects which implement the buffer protocol, but provide only immutable buffers. This would allow immutable objects (such as 'bytes') to be mutated, thus violating fundamental rules of Python and resulting in corrupted output. This issue has been present since 'update_into' was originally introduced in cryptography 1.8.
...
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/38448/97cBunknownJCVE-2020-10177�
...
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[<7.1.0]0:�Advisory: In libImaging/Jpeg2KDecode.c in Pillow before 7.1.0, there are multiple out-of-bounds reads via a crafted JP2 file.
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/38451/97cBunknownJCVE-2020-10994�
...
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[<10.2.0]0:�Advisory: Pillow is potentially vulnerable to DoS attacks through PIL.ImageFont.ImageFont.getmask(). A decompression bomb check has also been added to the affected function.
https://pillow.readthedocs.io/en/stable/releasenotes/10.2.0.html
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/64437/97cBunknown�
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[<10.2.0]0:�Advisory: Pillow is affected by an arbitrary code execution vulnerability. If an attacker has control over the keys passed to the environment argument of PIL.ImageMath.eval(), they may be able to execute arbitrary code.
https://pillow.readthedocs.io/en/stable/releasenotes/10.2.0.html
...
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/40594/97cBunknownJCVE-2021-28676�
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[<8.2.0]0:�Advisory: Pillow version 8.2.0 includes a fix for CVE-2021-28678: For BLP data, BlpImagePlugin did not properly check that reads (after jumping to file offsets) returned data. This could lead to a DoS where the decoder could be run a large number of times on empty data.
https://lists.fedoraproject.org/archives/list/package-announce@lists.fedoraproject.org/message/MQHA5HAIBOYI3R6HDWCLAGFTIQP767FL/
https://github.com/python-pillow/Pillow/pull/5377
...
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[<8.2.0]0:�Advisory: Pillow 8.2.0 includes a fix for CVE-2021-25288: There is an out-of-bounds read in J2kDecode, in j2ku_gray_i.
...
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[<8.2.0]0:�Advisory: Pillow 8.2.0 includes a fix for CVE-2021-25287: There is an out-of-bounds read in J2kDecode, in j2ku_graya_la.
https://pillow.readthedocs.io/en/stable/releasenotes/8.2.0.html#cve-2021-25287-cve-2021-25288-fix-oob-read-in-jpeg2kdecode
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/40592/97cBunknownJCVE-2021-25287�
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[<8.2.0]0:�Advisory: Pillow version 8.2.0 includes a fix for CVE-2021-28677: For EPS data, the readline implementation used in EPSImageFile has to deal with any combination of \r and \n as line endings. It used an accidentally quadratic method of accumulating lines while looking for a line ending. A malicious EPS file could use this to perform a DoS of Pillow in the open phase, before an image was accepted for opening.
https://lists.fedoraproject.org/archives/list/package-announce@lists.fedoraproject.org/message/MQHA5HAIBOYI3R6HDWCLAGFTIQP767FL/
https://github.com/python-pillow/Pillow/pull/5377
...
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[<9.1.1]0:�Advisory: Pillow 9.1.1 addresses the CVE-2022-30595: libImaging/TgaRleDecode.c in Pillow 9.1.0 has a heap buffer overflow in the processing of invalid TGA image files.
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/67137/97cBunknownJCVE-2022-30595�
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[>=5.2.0,<8.3.2]0:�Advisory: Pillow from 5.2.0 and before 8.3.2 is vulnerable to Regular Expression Denial of Service (ReDoS) via the getrgb function.
https://github.com/python-pillow/Pillow/commit/9e08eb8f78fdfd2f476e1b20b7cf38683754866b
https://pillow.readthedocs.io/en/stable/releasenotes/8.3.2.html
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/41271/97cBunknownJCVE-2021-23437�
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[<8.3.0]0:�Advisory: Pillow 8.3.0 includes a fix for CVE-2021-34552: Pillow through 8.2.0 and PIL (also known as Python Imaging Library) through 1.1.7 allow an attacker to pass controlled parameters directly into a convert function to trigger a buffer overflow in Convert.c
...
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[>=0,<8.2.0]0:�Advisory: An issue was discovered in Pillow before 8.2.0. PSDImagePlugin.PsdImageFile lacked a sanity check on the number of input layers relative to the size of the data block. This could lead to a DoS on Image.open prior to Image.load.
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/54688/97cBunknownJCVE-2021-28675�
...
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/44524/97cBunknown�
...
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[<9.0.0]0:�Advisory: Pillow 9.0.0 includes a fix for CVE-2022-22816: path_getbbox in path.c in Pillow before 9.0.0 has a buffer over-read during initialization of ImagePath.Path.
...
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[<9.0.0]0:�Advisory: Pillow 9.0.0 includes a fix for CVE-2022-22815: path_getbbox in path.c in Pillow before 9.0.0 improperly initializes ImagePath.Path.
https://pillow.readthedocs.io/en/stable/releasenotes/9.0.0.html#fixed-imagepath-path-array-handling
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/44485/97cBunknownJCVE-2022-22815�
...
https://pillow.readthedocs.io/en/stable/releasenotes/8.1.1.html
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/40272/97cBunknownJCVE-2021-25291�
...
https://pillow.readthedocs.io/en/stable/releasenotes/8.1.1.html
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/40273/97cBunknownJCVE-2021-25293�
...
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[<8.1.1]0:�Advisory: Pillow 8.1.1 includes a fix for CVE-2021-25292: The PDF parser allows a regular expression DoS (ReDoS) attack via a crafted PDF file because of a catastrophic backtracking regex.
https://pillow.readthedocs.io/en/stable/releasenotes/8.1.1.html
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/40266/97cBunknownJCVE-2021-25292�
...
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/40264/97cBunknownJCVE-2020-15999�
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[<9.2.0]0:�Advisory: Pillow before 9.2.0 performs Improper Handling of Highly Compressed GIF Data (Data Amplification).
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/51885/97cBunknownJCVE-2022-45198�
...
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/40271/97cBunknownJCVE-2020-35655�
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[<8.1.0]0:�Advisory: Pillow 8.1.0 fixes TIFF OOB Write error. CVE-2020-35654 #5175.
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/40265/97cBunknownJCVE-2020-35654�
...
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[>=4.3.0,<8.1.1]0:�Advisory: Pillow before 8.1.1 allows attackers to cause a denial of service (memory consumption) because the reported size of a contained image is not properly checked for an ICO container, and thus an attempted memory allocation can be very large.
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/40268/97cBunknownJCVE-2021-27923�
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[<6.2.2]0:�Advisory: There is a DoS vulnerability in Pillow before 6.2.2 caused by FpxImagePlugin.py calling the range function on an unvalidated 32-bit integer if the number of bands is large. On Windows running 32-bit Python, this results in an OverflowError or MemoryError due to the 2 GB limit. However, on Linux running 64-bit Python this results in the process being terminated by the OOM killer.
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/37772/97cBunknownJCVE-2019-19911�
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[<6.2.2]0:�Advisory: libImaging/SgiRleDecode.c in Pillow before 6.2.2 has an SGI buffer overflow.
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/37780/97cBunknownJ
CVE-2020-5311�
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[<6.2.2]0:�Advisory: libImaging/TiffDecode.c in Pillow before 6.2.2 has a TIFF decoding integer overflow, related to realloc.
...
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[<10.0.0]0:�Advisory: Pillow 10.0.0 includes a fix for CVE-2023-44271: Denial of Service that uncontrollably allocates memory to process a given task, potentially causing a service to crash by having it run out of memory. This occurs for truetype in ImageFont when textlength in an ImageDraw instance operates on a long text argument.
https://github.com/python-pillow/Pillow/pull/7244
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/62156/97cBunknownJCVE-2023-44271�
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[<10.3.0]0:�Advisory: Pillow 10.3.0 introduces a security update addressing CVE-2024-28219 by replacing certain functions with strncpy to prevent buffer overflow issues.
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/67136/97cBunknownJCVE-2024-28219�
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[<6.2.0]0:�Advisory: Pillow 6.2.0 includes a fix for CVE-2019-16865: An issue was discovered in Pillow before 6.2.0. When reading specially crafted invalid image files, the library can either allocate very large amounts of memory or take an extremely long period of time to process the image.
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/44744/97cBunknownJCVE-2019-16865�
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[<9.0.1]0:�Advisory: Pillow before 9.0.1 allows attackers to delete files because spaces in temporary pathnames are mishandled.
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/45356/97cBunknownJCVE-2022-24303�
pkg:pypi/pillow@5.4.1Vulnerable Dependencypillow[<9.0.1]0:�Advisory: Pillow 9.0.1 includes a fix for CVE-2022-22817: PIL.ImageMath.eval in Pillow before 9.0.0 allows evaluation of arbitrary expressions, such as ones that use the Python exec method. A first patch was issued for version 9.0.0 but it did not prevent builtins available to lambda expressions.
https://pillow.readthedocs.io/en/stable/releasenotes/9.0.1.html#security
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/44487/97cBunknownJCVE-2022-22817�
...
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/39195/97cBunknown�
...
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/39194/97cBunknownJCVE-2020-27783�
...
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/40072/97cBunknownJCVE-2021-28957�
pkg:pypi/lxml@4.2.5Vulnerable Dependencylxml[<4.9.1]0:�Advisory: Lxml 4.9.1 includes a fix for CVE-2022-2309: NULL Pointer Dereference allows attackers to cause a denial of service (or application crash). This only applies when lxml is used together with libxml2 2.9.10 through 2.9.14. libxml2 2.9.9 and earlier are not affected. It allows triggering crashes through forged input data, given a vulnerable code sequence in the application. The vulnerability is caused by the iterwalk function (also used by the canonicalize function). Such code shouldn't be in wide-spread use, given that parsing + iterwalk would usually be replaced with the more efficient iterparse function. However, an XML converter that serialises to C14N would also be vulnerable, for example, and there are legitimate use cases for this code sequence. If untrusted input is received (also remotely) and processed via iterwalk function, a crash can be triggered.
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/50748/97cBunknownJ
CVE-2022-2309�
pkg:pypi/scikit-learn@0.20.2Vulnerable Dependencyscikit-learn[<0.24.2]0:�Advisory: Scikit-learn 0.24.2 includes a fix for a ReDoS vulnerability.
https://github.com/scikit-learn/scikit-learn/issues/19522
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/52255/97cBunknown�
pkg:pypi/scikit-learn@0.20.2Vulnerable Dependencyscikit-learn[<1.1.0rc1]0:�Advisory: Scikit-learn 1.1.0rc1 includes a fix for CVE-2020-28975: svm_predict_values in svm.cpp in Libsvm v324, as used in scikit-learn and other products, allows attackers to cause a denial of service (segmentation fault) via a crafted model SVM (introduced via pickle, json, or any other model permanence standard) with a large value in the _n_support array. 
...
pkg:pypi/scipy@1.2.0Vulnerable Dependencyscipy[<1.10.0rc1]0:�Advisory: Scipy 1.10.0rc1 includes a fix for a Denial of Service vulnerability.
...
scipy[<1.8.0]0:�Advisory: Scipy 1.8.0 includes a fix for an Use After Free vulnerability.
https://github.com/scipy/scipy/issues/14713
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/59398/97cBunknownJCVE-2023-29824�
...
pkg:pypi/numpy@1.16.0Vulnerable Dependencynumpy[<1.16.3]0:�Advisory: Numpy 1.16.3 includes a fix for CVE-2019-6446: It uses the pickle Python module unsafely, which allows remote attackers to execute arbitrary code via a crafted serialized object, as demonstrated by a numpy.load call.
...
CVE-2019-6446�
pkg:pypi/numpy@1.16.0Vulnerable Dependencynumpy[<1.22.2]0:�Advisory: Numpy 1.22.2  includes a fix for CVE-2021-41495: Null Pointer Dereference vulnerability exists in numpy.sort in NumPy in the PyArray_DescrNew function due to missing return-value validation, which allows attackers to conduct DoS attacks by repetitively creating sort arrays. 
...
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/44715/97cBunknownJCVE-2021-41495�
pkg:pypi/numpy@1.16.0Vulnerable Dependencynumpy[<1.22.0]0:�Advisory: Numpy 1.22.0 includes a fix for CVE-2021-34141: An incomplete string comparison in the numpy.core component in NumPy before 1.22.0 allows attackers to trigger slightly incorrect copying by constructing specific string objects. 
NOTE: the vendor states that this reported code behavior is "completely harmless."
https://github.com/numpy/numpy/issues/18993
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/44717/97cBunknownJCVE-2021-34141�
pkg:pypi/numpy@1.16.0Vulnerable Dependencynumpy[<1.22.0]0:�Advisory: Numpy 1.22.0 includes a fix for CVE-2021-41496: Buffer overflow in the array_from_pyobj function of fortranobject.c, which allows attackers to conduct a Denial of Service attacks by carefully constructing an array with negative values. 
...
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/44716/97cBunknownJCVE-2021-41496�
...
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/43453/97cBunknownJCVE-2021-33430�
pkg:pypi/requests@2.20.0Vulnerable Dependencyrequests[>=2.3.0,<2.31.0]0:�Advisory: Requests 2.31.0 includes a fix for CVE-2023-32681: Since Requests 2.3.0, Requests has been leaking Proxy-Authorization headers to destination servers when redirected to an HTTPS endpoint. This is a product of how we use 'rebuild_proxies' to reattach the 'Proxy-Authorization' header to requests. For HTTP connections sent through the tunnel, the proxy will identify the header in the request itself and remove it prior to forwarding to the destination server. However when sent over HTTPS, the 'Proxy-Authorization' header must be sent in the CONNECT request as the proxy has no visibility into the tunneled request. This results in Requests forwarding proxy credentials to the destination server unintentionally, allowing a malicious actor to potentially exfiltrate sensitive information.
...
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/51340/97cBunknownJCVE-2022-41323�
...
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/52945/97cBunknownJCVE-2023-23969�
...
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/44423/97cBunknownJCVE-2021-45115�
...
https://www.djangoproject.com/weblog/2022/jan/04/security-releases
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/44427/97cBunknownJCVE-2021-45116�
...
pkg:pypi/django@1.11.29Vulnerable Dependencydjango[<2.2.21]0:�Advisory: Django 2.2.21, 3.1.9 and 3.2.1 include a fix for CVE-2021-31542: MultiPartParser, UploadedFile, and FieldFile allowed directory traversal via uploaded files with suitably crafted file names.
...
pkg:pypi/django@1.11.29Vulnerable Dependencydjango[<2.2.24]0:�Advisory: Django 2.2.24, 3.1.12, and 3.2.4 include a fix for CVE-2021-33571: In Django 2.2 before 2.2.24, 3.x before 3.1.12, and 3.2 before 3.2.4, URLValidator, validate_ipv4_address, and validate_ipv46_address do not prohibit leading zero characters in octal literals. This may allow a bypass of access control that is based on IP addresses. (validate_ipv4_address and validate_ipv46_address are unaffected with Python 3.9.5+).
...
pkg:pypi/django@1.11.29Vulnerable Dependencydjango[<2.2.19]0:�Advisory: Django versions 2.2.19, 3.0.13 and 3.1.7 include a fix for CVE-2021-23336: Web cache poisoning via 'django.utils.http.limited_parse_qsl()'. Django contains a copy of 'urllib.parse.parse_qsl' which was added to backport some security fixes. A further security fix has been issued recently such that 'parse_qsl(' no longer allows using ';' as a query parameter separator by default.
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/39646/97cBunknownJCVE-2021-23336�
pkg:pypi/django@1.11.29Vulnerable Dependencydjango[<3.2.19]0:�Advisory: Django 4.2.1, 4.1.9 and 3.2.19 include a fix for CVE-2023-31047: In Django 3.2 before 3.2.19, 4.x before 4.1.9, and 4.2 before 4.2.1, it was possible to bypass validation when using one form field to upload multiple files. This multiple upload has never been supported by forms.FileField or forms.ImageField (only the last uploaded file was validated). However, Django's "Uploading multiple files" documentation suggested otherwise.
https://www.djangoproject.com/weblog/2023/may/03/security-releases
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/55264/97cBunknownJCVE-2023-31047�
pkg:pypi/django@1.11.29Vulnerable Dependencydjango[<2.2.27]0:�Advisory: The {% debug %} template tag in Django 2.2 before 2.2.27, 3.2 before 3.2.12, and 4.0 before 4.0.2 does not properly encode the current context. This may lead to XSS.
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/44742/97cBunknownJCVE-2022-22818�
...
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/44741/97cBunknownJCVE-2022-23833�
...
pkg:pypi/django@1.11.29Vulnerable Dependencydjango[<2.2.16]0:�Advisory: An issue was discovered in Django 2.2 before 2.2.16, 3.0 before 3.0.10, and 3.1 before 3.1.1 (when Python 3.7+ is used). The intermediate-level directories of the filesystem cache had the system's standard umask rather than 0o077.
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/38752/97cBunknownJCVE-2020-24584�
pkg:pypi/django@1.11.29Vulnerable Dependencydjango[<2.1.9]0:�Advisory: Django versions 2.1.9 and 2.2.2 include a patched bundled jQuery version to avoid a Prototype Pollution vulnerability.
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/39594/97cBunknownJCVE-2019-11358�
pkg:pypi/django@1.11.29Vulnerable Dependencydjango[<3.2.23]0:�Advisory: Django 4.2.7, 4.1.13 and 3.2.23 include a fix for CVE-2023-46695: Potential denial of service vulnerability in UsernameField on Windows.
https://www.djangoproject.com/weblog/2023/nov/01/security-releases
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/62126/97cBunknownJCVE-2023-46695�
pkg:pypi/django@1.11.29Vulnerable Dependencydjango[<3.2.15]0:�Advisory: Django 3.2.15 and 4.0.7 include a fix for CVE-2022-36359: An issue was discovered in the HTTP FileResponse class in Django 3.2 before 3.2.15 and 4.0 before 4.0.7. An application is vulnerable to a reflected file download (RFD) attack that sets the Content-Disposition header of a FileResponse when the filename is derived from user-supplied input.
https://www.djangoproject.com/weblog/2022/aug/03/security-releases
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/50454/97cBunknownJCVE-2022-36359�
pkg:pypi/django@1.11.29Vulnerable Dependencydjango[<3.2.25]0:�Advisory: Affected versions of Django are vulnerable to potential regular expression denial-of-service (REDoS). django.utils.text.Truncator.words() method (with html=True) and truncatewords_html template filter were subject to a potential regular expression denial-of-service attack using a suitably crafted string (follow up to CVE-2019-14232 and CVE-2023-43665).
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/65771/97cBunknownJCVE-2024-27351�
pkg:pypi/django@1.11.29Vulnerable Dependencydjango[<3.2.24]0:�Advisory: Affected versions of Django are vulnerable to potential denial-of-service in intcomma template filter when used with very long strings.
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/64976/97cBunknownJCVE-2024-24680�
pkg:pypi/django@1.11.29Vulnerable Dependencydjango[<3.2.18]0:�Advisory: Django 4.1.7, 4.0.10 and 3.2.18 include a fix for CVE-2023-24580: Potential denial-of-service vulnerability in file uploads.
https://www.djangoproject.com/weblog/2023/feb/14/security-releases
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/53315/97cBunknownJCVE-2023-24580�
pkg:pypi/django@1.11.29Vulnerable Dependencydjango[<2.2.28]0:�Advisory: Django 2.2.28, 3.2.13 and 4.0.4 include a fix for CVE-2022-28347: A SQL injection issue was discovered in QuerySet.explain() in Django 2.2 before 2.2.28, 3.2 before 3.2.13, and 4.0 before 4.0.4. This occurs by passing a crafted dictionary (with dictionary expansion) as the **options argument, and placing the injection payload in an option name.
https://www.djangoproject.com/weblog/2022/apr/11/security-releases
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/48040/97cBunknownJCVE-2022-28347�
pkg:pypi/django@1.11.29Vulnerable Dependencydjango[<2.2.28]0:�Advisory: Django 2.2.28, 3.2.13 and 4.0.4 include a fix for CVE-2022-28346: An issue was discovered in Django 2.2 before 2.2.28, 3.2 before 3.2.13, and 4.0 before 4.0.4. QuerySet.annotate(), aggregate(), and extra() methods are subject to SQL injection in column aliases via a crafted dictionary (with dictionary expansion) as the passed **kwargs.
https://www.djangoproject.com/weblog/2022/apr/11/security-releases
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/48041/97cBunknownJCVE-2022-28346�
pkg:pypi/django@1.11.29Vulnerable Dependencydjango[<2.2.25]0:�Advisory: Django versions 2.2.25, 3.1.14 and 3.2.10 include a fix for CVE-2021-44420: In Django 2.2 before 2.2.25, 3.1 before 3.1.14, and 3.2 before 3.2.10, HTTP requests for URLs with trailing newlines could bypass upstream access control based on URL paths.
https://www.djangoproject.com/weblog/2021/dec/07/security-releases/
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/43041/97cBunknownJCVE-2021-44420�
...
Fixed Versions: [],Resources: [], More Info: https://data.safetycli.com/v/59293/97cBunknownJCVE-2023-36053�
pkg:pypi/django@1.11.29Vulnerable Dependencydjango[<3.2.22]0:�Advisory: Affected versions of Django are vulnerable to Denial-of-Service via django.utils.text.Truncator. The django.utils.text.Truncator chars() and words() methods (when used with html=True) are subject to a potential DoS (denial of service) attack via certain inputs with very long, potentially malformed HTML text. The chars() and words() methods are used to implement the truncatechars_html and truncatewords_html template filters, which are thus also vulnerable. NOTE: this issue exists because of an incomplete fix for CVE-2019-14232.
