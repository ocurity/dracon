...
func TestUploadBomsFromRaw(t *testing.T) {
	projUIID := uuid.MustParse("7c78f6c9-b4b0-493c-a912-0bb0a4f221f1")
	expectedRequest := dtrack.BOMUploadRequest{
		ProjectName:    "test",
		ProjectUUID:    &projUIID,
	...
	expectedToken := "7c78f6c9-token" // nosec:G101
	...
	projectUUID = "7c78f6c9-b4b0-493c-a912-0bb0a4f221f1"
	apiKey = "test"
	projectName = "test"
